<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TrainingDocuments.aspx.vb" Inherits="WebSysME.TrainingDocuments" MasterPageFile="~/Site.Master"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="4" style="margin-left:2%">
        <tr>
            <td>Attach Training Documents<br /></td>
        </tr>
        <tr> 
		<td colspan="2"> 
