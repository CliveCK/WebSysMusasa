...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            With cboEvaluation
                ...
                .DataSource = objLookup.Lookup("tblEvaluation", "EvaluationID", "Name").Tables(0)
    ...
    Protected Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If Map() Then
            ...
            ShowMessage("Evaluation mapped successfully...", MessageTypeEnum.Information)
        ...
        If mObject.Length > 0 Then
            ...
            For i As Long = 0 To mObject.Length - 1
                ...
                With objObjects
                    ...
                    If cboEvaluation.Entries.Count > 0 Then

                        .EvaluationID = cboEvaluation.Entries.Item(0).Value
    ...
    Private Sub radObjects_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles radObjects.NeedDataSource
        ...
        radObjects.DataSource = DirectCast(ViewState("eObjects"), DataTable)
    ...
    Private Sub cboObjectType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboObjectType.SelectedIndexChanged
        ...
        If cboObjectType.SelectedIndex > 0 Then
            ...
            Dim sql As String = "SELECT ObjectID FROM tblEvaluationObjects O inner join luObjectTypes OT "
            sql &= " on OT.ObjectTypeID = O.ObjectTypeID where O.EvaluationID = " & cboEvaluation.Entries.Item(0).Value & " AND OT.ObjectType = " & cboObjectType.SelectedValue
