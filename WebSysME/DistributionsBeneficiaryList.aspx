<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DistributionsBeneficiaryList.aspx.vb" Inherits="WebSysME.DistributionsBeneficiaryList" MasterPageFile="~/Site.Master"%>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    <div style="margin-left:2%">
    <h4>Distributions Beneficiaries</h4>
    <br />
