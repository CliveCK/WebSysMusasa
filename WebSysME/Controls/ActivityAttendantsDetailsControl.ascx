<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ActivityAttendantsDetailsControl.ascx.vb" Inherits="WebSysME.ActivityAttendantsDetailsControl" %>
...
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td colspan="4" class="PageTitle"><h4>Activity Participants</h4></td> 
	</tr> 
	<tr>
		<td >Activity</td> 
    </tr>
    <tr>
        	<td ><asp:dropdownlist id="cboActivity" runat="server" CssClass="form-control" AutoPostBack="true"></asp:dropdownlist> </td> 
	</tr>
    <tr> 
		<td colspan="4"> <br />
    ...
    <tr>
        <td>
            <telerik:RadGrid ID="radAttendantActivity" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="True"
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgEdit" runat="server" AlternateText="Cancel" CausesValidation="False" Visible="false"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ActivityAttendantID")%>'
	...
	<tr> 
		<td colspan="4"> 
			<asp:TextBox id="ActivityAttendantID" runat="server" Visible="false"></asp:TextBox> 
		</td> 
	</tr> 
</table>
</div> 
