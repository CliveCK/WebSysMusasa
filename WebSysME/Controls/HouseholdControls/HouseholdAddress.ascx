<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="HouseholdAddress.ascx.vb" Inherits="WebSysME.HouseholdAddress" %>
<div style="padding-left:2%"><br />
<fieldset>
    <legend>Beneficiary Address</legend><br />
    ...
    <tr>
        <td colspan="4">
            <asp:RadioButtonList runat="server" ID="chkIsRuralUrban" RepeatDirection="Horizontal" RepeatLayout="Table" AutoPostBack="true" >
                <asp:ListItem Value="IsRural">Rural Household</asp:ListItem>
