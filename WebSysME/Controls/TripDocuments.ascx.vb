...
#End Region
    ...
    Protected Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim ObjectTypeID As Integer = db.ExecuteScalar(CommandType.Text, "SELECT TOP 1 ObjectTypeID FROM luDocumentObjectTypes WHERE Description = 'ProjectTrips'")
    ...
    Public Function Save(ByVal FilePath As String, ByVal FileExt As String, ByVal ObjectTypeID As Long) As Boolean
        ...
        Try
            ...
            Dim FileType As Long = db.ExecuteScalar(CommandType.Text, "SELECT TOP 1 FileTypeID FROM luFileTypes where Description = 'ProjectTrips'")
            Dim objFiles As New BusinessLogic.Files(CookiesWrapper.thisConnectionName, CookiesWrapper.thisUserID)
    ...
    Private Sub LoadGrid()
        ...
        sql &= " inner join tblTrips T on T.TripID = O.ObjectID "
        sql &= " inner join luObjectTypes OT on OT.ObjectTypeID = O.ObjectTypeID  WHERE OT.Description = 'ProjectTrips' "
        sql &= " AND T.TripID = " & IIf(IsNumeric(txtTripID.Text), txtTripID.Text, 0)
    ...
    Private Sub radFileListing_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles radFileListing.NeedDataSource
        ...
        radFileListing.DataSource = Session("mFiles")
