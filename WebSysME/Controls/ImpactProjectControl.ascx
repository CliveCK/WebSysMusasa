<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ImpactProjectControl.ascx.vb" Inherits="WebSysME.ImpactProjectControl" %>


<div style="padding-left:2%">
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td colspan="2" class="PageTitle"><h4>Impact Projects</h4></td> 
	</tr> 
	<tr>
		<td >Impact</td>
    ...
    <tr>
        <td colspan="2">
            <telerik:RadGrid ID="radProjects" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="True"
