<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ObjectiveOutputDetailsControl.ascx.vb" Inherits="WebSysME.OutputDetailsControl" %>


<div style="padding-left:2%">
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td colspan="4" class="PageTitle"><h4>Objective outputs</h4></td> 
	</tr> 
	<tr>
		<td >Objective</td> 
    </tr>
    <tr>
        	<td ><asp:dropdownlist id="cboObjectives" runat="server" CssClass="form-control" AutoPostBack="true"></asp:dropdownlist> </td> 
	</tr>
    <tr>
        <td>
            &nbsp;
    ...
    <tr>
        <td>
            <telerik:RadGrid ID="radOutputs" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="True"
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgEdit" runat="server" AlternateText="Cancel" CausesValidation="False" Visible="false"
                                    CommandArgument='<%# DataBinder.Eval(Container.DataItem, "OutputID")%>'
	...
	<tr> 
		<td colspan="4"> 
			<asp:TextBox id="txtProjectObjectiveID" runat="server" Visible="false"></asp:TextBox> 
		</td> 
	</tr> 
</table>
</div> 
