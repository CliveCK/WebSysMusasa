...
Public Class ProjectObjectsDetailsControl
...
#End Region
    ...
    Public Function DertemineObjectTypeSQL(ByVal Type As String) As String
        ...
        Select Case Type
            ...
            Case "KeyChangePromise"
                sql = "SELECT KeyChangePromiseID as ObjectID, KeyChangePromiseNo FROM tblKeyChangePromises"

            Case "Evaluation"
                sql = "SELECT EvaluationID as ObjectID, Name, FromDate, ToDate, Description, Comments FROM tblEvaluations"
    ...
    Private Sub cboObjectType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboObjectType.SelectedIndexChanged
        ...
        If cboProjects.SelectedIndex > 0 Then
            ...
            If cboObjectType.SelectedIndex > 0 Then
                ...
                Dim sql As String = "SELECT ObjectID FROM tblProjects P inner join tblProjectObjects O on P.Project = O.ProjectID inner join luObjectTypes OT "
                sql &= " on OT.ObjectTypeID = O.ObjectTypeID where O.ProjectID = " & cboProjects.SelectedValue & " AND OT.Description = '" & cboObjectType.SelectedValue & "'"
        ...
        Else
            ...
            ShowMessage("Please select project first...", MessageTypeEnum.Error)
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If Map() Then
            ...
            ShowMessage("Project mapped successfully...", MessageTypeEnum.Information)
    ...
    Private Sub radObjects_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles radObjects.NeedDataSource
        ...
        radObjects.DataSource = DirectCast(ViewState("mObjects"), DataTable)
