...
Partial Public Class SurveyDetailsControl
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtSurveyID As Global.System.Web.UI.WebControls.DropDownList

    '''<summary>
    '''radSurveyListing control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents radSurveyListing As Global.Telerik.Web.UI.RadGrid
End Class
