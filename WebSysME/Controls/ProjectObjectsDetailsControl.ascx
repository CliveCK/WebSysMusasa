<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProjectObjectsDetailsControl.ascx.vb" Inherits="WebSysME.ProjectObjectsDetailsControl" %>

<table cellpadding="3" cellspacing="0" border="0" style="width:100%;margin-left:2%"> 
	<tr> 
		<td colspan="4" class="PageTitle"><h4>Project Mapping</h4></td> 
	</tr> 
	<tr> 
		<td >Project</td> 
        	<td> <asp:dropdownlist id="cboProjects" runat="server" CssClass="form-control" ></asp:dropdownlist></td> 
	</tr> 
	<tr> 
		<td >Map to:</td> 
