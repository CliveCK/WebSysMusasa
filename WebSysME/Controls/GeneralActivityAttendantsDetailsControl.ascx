<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="GeneralActivityAttendantsDetailsControl.ascx.vb" Inherits="WebSysME.GeneralActivityAttendantsDetailsControl" %>
<table cellpadding="4" cellspacing="0" border="0" style="width:100%;margin-left:2%"> 
	...
	<tr> 
		<td colspan="4"> 
			<asp:TextBox  id="txtGeneralActivityAttendantID" runat="server" CssClass="HiddenControl"></asp:TextBox> 
		</td> 
	</tr> 
    <tr>
        <td>
            <asp:LinkButton runat="server" ID="lnkBack" Text="<< Back to Activities Details" Font-Bold="true"></asp:LinkButton>
        </td>
    </tr>
</table> 
