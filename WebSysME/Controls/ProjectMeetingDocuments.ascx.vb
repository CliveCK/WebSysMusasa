...
#End Region
    ...
    Protected Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim ObjectTypeID As Integer = db.ExecuteScalar(CommandType.Text, "SELECT TOP 1 ObjectTypeID FROM luObjectTypes WHERE Description = 'ProjectMeetings'")
                ...
                If IsNumeric(txtProjectMeetingID.Text) Then
                    ...
                    If .Save() Then
                        ...
                        With objObjects
                            ...
                            .ObjectID = txtProjectMeetingID.Text
    ...
    Private Sub LoadGrid()
        ...
        sql &= " inner join luObjectTypes OT on OT.ObjectTypeID = O.ObjectTypeID  WHERE OT.Description = 'ProjectMeetings' "
    ...
    Private Sub radFileListing_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles radFileListing.NeedDataSource
        ...
        radFileListing.DataSource = Session("tFiles")
