<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="OutputActivityDetailsControl.ascx.vb" Inherits="WebSysME.OutputActivityDetailsControl" %>
...
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td colspan="4" class="PageTitle"><h4>Output Activity</h4></td> 
	</tr> 
	<tr>
		<td >Output</td> 
    </tr>
