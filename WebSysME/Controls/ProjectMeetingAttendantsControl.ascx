<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProjectMeetingAttendantsControl.ascx.vb" Inherits="WebSysME.ProjectMeetingAttendantsControl" %>

<table cellpadding="4" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td class="PageTitle"><h5><b>Project Meeting Attendants</b></h5><br /></td> 
	</tr>
    <tr>
        <td>Staff</td>
    </tr>
    <tr>
		<td >
            <telerik:RadGrid ID="radStaff1" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="true" CellPadding="0" Width="100%">                
                        <ClientSettings>
                            <Selecting AllowRowSelect="True" />
                        </ClientSettings>
                    <MasterTableView AutoGenerateColumns="False" AllowPaging="True" AllowFilteringByColumn="True"  PagerStyle-Mode="NextPrevNumericAndAdvanced"
