<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ObjectiveOutcomesDetailsControl.ascx.vb" Inherits="WebSysME.ObjectiveOutcomesDetailsControl" %>


<div style="padding-left:2%">
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
	<tr> 
		<td colspan="2" class="PageTitle"><h4>Objective Outcomes</h4></td> 
	</tr> 
	<tr>
		<td >Objective</td>
    ...
    <tr>
        <td colspan="2">
            <telerik:RadGrid ID="radOutcomes" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="True"
