<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProjectMeetingDocuments.ascx.vb" Inherits="WebSysME.ProjectMeetingDocuments" %>
...
<table>
    ...
    <tr>
        <td><asp:textbox id="txtFileID" runat="server" Visible="false"></asp:textbox>
            <asp:textbox id="txtProjectMeetingID" runat="server" Visible="false"></asp:textbox>
