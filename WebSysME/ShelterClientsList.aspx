<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ShelterClientsList.aspx.vb" Inherits="WebSysME.ShelterClientsList" %>
                    ...
                    <MasterTableView AllowFilteringByColumn="True" AllowPaging="True" 
                       AllowMultiColumnSorting="true" AllowSorting="true" PagerStyle-Mode="NextPrevNumericAndAdvanced">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="AssignedBy" HeaderText="AssignedBy" UniqueName="AssignedBy">
                            </telerik:GridBoundColumn>
                             <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="column" Text="View" CommandName="View">
                            </telerik:GridButtonColumn>  
                             <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="column1" Text="Activity" CommandName="Activity">
                            </telerik:GridButtonColumn> 
                        </Columns>
                        <RowIndicatorColumn>
