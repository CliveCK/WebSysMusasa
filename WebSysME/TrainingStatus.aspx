<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TrainingStatus.aspx.vb" Inherits="WebSysME.TrainingStatus" MasterPageFile="~/Site.Master"%>
...
<table cellpadding="2" cellspacing="0" border="0" style="width:100%"> 
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="cboTrainingStatus" runat="server" CssClass="form-control"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td colspan="2">
            <telerik:RadGrid ID="radAttendants" runat="server" GridLines="None" Height="100%" AllowMultiRowSelection="True"
