...
Public Class TrainingPermissions
    ...
    Private Sub ReceiveControlMessage(ByVal Message As String, ByVal MessageType As MessageTypeEnum) Handles TrainingPermissionsControl1.ReceiveControlMessage
