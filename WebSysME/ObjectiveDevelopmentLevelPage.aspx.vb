...
Public Class ObjectiveDevelopmentLevelPage
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            With cboDevelopmentLevel

                .DataSource = objLookup.Lookup("luDevelopmentLevel", "DevelopmentLevelID", "Description").Tables(0)
                .DataValueField = "DevelopmentLevelID"
    ...
    Private Function Map() As Boolean
        ...
        If Objectives.Length > 0 Then
            ...
            For i As Long = 0 To Objectives.Length - 1
                ...
                Dim objObjectiveOutcomes As New BusinessLogic.ObjectiveDevelopmentLevel(CookiesWrapper.thisConnectionName, CookiesWrapper.thisUserID)

                With objObjectiveOutcomes

                    .DevelopmentLevelID = cboDevelopmentLevel.SelectedValue
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            Select Case e.CommandName
                ...
                Case "Delete"
                    ...
                    Dim objObjectiveThemes As New BusinessLogic.ObjectiveDevelopmentLevel(CookiesWrapper.thisConnectionName, CookiesWrapper.thisUserID)
    ...
    Private Sub radObjectives_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles radObjectives.NeedDataSource
        ...
        radObjectives.DataSource = Session("miObjectives")
    ...
    Private Sub cboDevelopmentLevel_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboDevelopmentLevel.SelectedIndexChanged
